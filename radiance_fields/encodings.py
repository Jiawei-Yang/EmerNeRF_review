...
class SinusoidalEncoder(XYZ_Encoder):
    ...
    def __init__(self, n_input_dims, min_deg, max_deg, enable_identity: bool = True):
        super().__init__(n_input_dims)
        self.n_input_dims = n_input_dims
...
def build_xyz_encoder_from_cfg(xyz_encoder_cfg, verbose=True) -> XYZ_Encoder:
    # TODO: Figure out a better way to fill in the missing parameters in the config file.

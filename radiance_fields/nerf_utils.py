...
def find_topk_nearby_timestamps(
    ...
    Parameters:
    - original (torch.Tensor): Original tensor of timestamps.
    - query (torch.Tensor): Query tensor of timestamps for which closest indices are to be found.

    Returns:
    - torch.Tensor: Indices in the original tensor that are the two closest to each timestamp in the query tensor.
    """
